...
This is a minor fork of the original Pywal by dylanaraps on GitHub. Please support the original creator.
Tweaked to enable Pywal to actually set the wallpaper in KDE Plasma
